...
public class Player extends GameObject {
    private final String SPRITE_SHEET_PATH = "png/skelly.png";
    ...
    private Map<String, AnimationInfo> initAnimationMap() {
        ...
        animationMap.put("still_up", new AnimationInfo(0,1,8));
        animationMap.put("still_left", new AnimationInfo(1,1,8));
        animationMap.put("still_down", new AnimationInfo(2,1,8));
        animationMap.put("still_right", new AnimationInfo(3,1,8));
        return animationMap;
    }
}
